...
# Configuration
base_output_dir="/home/chenluy/reinforce_flow/data/gen_data/Reinforce-Ada_Qwen2.5-Math-1.5B_positive_focused_2"
...
models=()
base_model_path="/opt/dlami/nvme/chenluy_ckpoints/Reinforce-Ada/Reinforce-Ada_Qwen2.5-Math-1.5B_positive_focused_2"

# merge the model
for step in $(seq 300 50 400); do
